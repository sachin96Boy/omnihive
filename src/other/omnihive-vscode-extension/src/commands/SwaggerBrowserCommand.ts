...
export class SwaggerBrowserCommand {
    public setup = (context: vscode.ExtensionContext) => {
        const cmdOhSwagger = vscode.commands.registerCommand(VsCodeCommand.SwaggerBrowser, (args: SwaggerTreeItemModel) => {
            ...
            panelProvider.generateNewPanel(context, "ohSwaggerBrowserPanel", panelName, VsCodeWebpanelRoute.SwaggerBrowser, {
